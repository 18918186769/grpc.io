...
install gRPC before building and running the Hello World example.

### Setup

Choose a directory to hold the local package installations. This page assumes
that the environment variable `MY_INSTALL_DIR` holds this directory path. For
example:
...
install a more recent version as follows:
...
The following instructions will locally install gRPC and Protocol Buffers.
 ...
 2. Build and locally install gRPC and all requisite tools:
